  ...
  const steps = [
    {
      ...
      content: (
        <div className="space-y-4 text-sm leading-relaxed text-gray-700 dark:text-gray-300">
          <p>
            The authors will have to submit a camera-ready version as per the guidelines given on the conference website <strong>on or before 10th May 2026</strong>.
          </p>
      ...
      content: (
        <div className="space-y-4 text-sm leading-relaxed text-gray-700 dark:text-gray-300">
          ...
          <div className="flex items-center gap-3 bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-800 rounded-lg p-4">
            ...
            <span className="font-semibold text-rose-800 dark:text-rose-300">Deadline: May 10th, 2026</span>
          </div>
